...
import { User, Pill, ClipboardList, Package, Settings } from "lucide-react";
...
export default function DonorDashboard() {
  ...
  const cards = [
    ...
    },
    {
      ...
      desc: "Donate unused or surplus medicines safely.",
      link: "donar/postmed",
      bg: "bg-[#1e293b]",
    },
    {
      title: "Medicine Manager",
      icon: <ClipboardList size={40} className="text-[#10b981]" />,
      desc: "Track and manage your medicine donations.",
      link: "donar/managemed",
      bg: "bg-[#0f172a]",
    },
    {
      title: "Donate Equipment",
      icon: <Package size={40} className="text-[#ef4444]" />,
      desc: "Help by donating medical equipment.",
      link: "donar/donateequip",
      bg: "bg-[#1e293b]",
    },
    {
      title: "Equipment Manager",
      icon: <Settings size={40} className="text-[#8b5cf6]" />,
      desc: "Monitor and manage equipment donations.",
      link: "donar/manageequip",
      bg: "bg-[#0f172a]",
    },
  ];
