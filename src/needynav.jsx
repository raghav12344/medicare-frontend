...
export default function NeedyNavbar() {
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="px-4 py-2">
              <button className="w-full bg-[#38bdf8] text-[#0f172a] px-4 py-2 rounded-lg font-semibold hover:bg-[#fbbf24] transition"
              onClick={()=>{
                if(confirm("Do U want to logout"))
                {
                  localStorage.removeItem("activeUser");
